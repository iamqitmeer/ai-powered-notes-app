      ...
      <div className="container relative">
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative inline-flex">
            <h1 className="inline-flex text-center text-7xl font-bold tracking-tighter sm:text-[150px]">
              Write Notes, <br /> Stay Simple
            </h1>
            <motion.div
              className="absolute right-[658px] top-[70px] hidden sm:inline"
              drag
              dragSnapToOrigin
              initial={{ y: 0 }}
        ...
        <div className="flex justify-center">
          <p className="mt-8 max-w-md text-center text-xl">
            Keep track of how you are doing and enjoy every
            success with our easy-to-use web app.
          </p>
        </div>
